  ...
  <div>
    ...
    >
      <el-button
        ...
        @click="showModal"
      /></el-input>
    <el-dialog title="GCS评估" :visible.sync="modalVisible" append-to-body>
      <el-form ref="form" :model="form" label-width="120px">
        <div class="flex-c-b">
          <el-form-item prop="PHEP_eyeReaction" label="睁眼反应(E)">
            <med-radio
              v-model="findItem('PHEP_eyeReaction').value"
              :readonly="readonly"
              border
              :options="dictionary[dic.PHEP_eyeReaction]"
            />
          </el-form-item>
          <el-form-item prop="PHEP_voiceReaction" label="语音反应(V)">
            <med-radio
              v-model="findItem('PHEP_voiceReaction').value"
              :readonly="readonly"
              border
              :options="dictionary[dic.PHEP_voiceReaction]"
            />
          </el-form-item>
          <el-form-item prop="PHEP_limbsMotion" label="肢体运动(M)">
            <med-radio
              v-model="findItem('PHEP_limbsMotion').value"
              :readonly="readonly"
              border
              :options="dictionary[dic.PHEP_limbsMotion]"
            />
          </el-form-item>
        </div>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        details: [
          {
            type: 'PHEP_eyeReaction',
            value: ''
          },
          {
            type: 'PHEP_voiceReaction',
            value: ''
          },
          {
            type: 'PHEP_limbsMotion',
            value: ''
          }
        ],
        doctor: '',
  ...
  computed: {
    ...
    judgmentBasis() {
      return this.dictionary[dic.GCSBasis]
    },
    score() {
