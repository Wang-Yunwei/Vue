<template>
  <div class="edit-panel">
    <el-container>
      <!-- <el-header class="base-area">
        <baseinfo
          :detail-data="detailData"
        /></el-header> -->
      <el-container>
        <el-aside class="timeline-area">
          <timeline :id="registId" ref="timeline" @change="getDetail" />
        </el-aside>
        <el-main class="content-area">
          ...
          <div class="flex-c-b foot-bar">
            ...
            <div class="right-part">
              ...
              <el-button
                v-if="
                  missionStatus != '06' && missionStatus != '07' && isSubmit
                "
                type="danger"
                plain
                size="small"
    ...
    <iframe ref="printIframe" :src="pdfSrc" style="width: 0; height: 0" />
  </div>
</template>

<script>
import timeline from '../timeline'
import FirstaidInfo from './tabs/firstaidInfo'
import History from './tabs/history'
import PhysicalExam from './tabs/physicalexam'
import AuxiliaryExam from './tabs/auxiliaryexam'
import Diagnosis from './tabs/diagnosis'
import InformedConsent from './tabs/informedconsent'
import Handover from './tabs/handover'
...
export default {
  ...
  mounted() {
    this.getIDsByPatientId()
    this.getDetail()
  },
  methods: {
    ...mapMutations(['mission/SET_MISSION']),
    async getIDsByPatientId() {
      const res = await getIDsByPatientId(this.patientId)
      const { hospitalArea } = res.body || {}
