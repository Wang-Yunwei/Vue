...
//     return {
//       flag: false,
//       hospitalId: this._permission().hospitalId,
//       codeList: [
...
//         dicConstant.qrCode,
//         dicConstant.reportStatus,
//         dicConstant.conditionGrade,
//         dicConstant.rescueChangeResult,
//         dicConstant.tntUnit
//       ],
//       // 证件类型
//       idCardTypeOpts: [],
...
//     dictionariesData() {
//       return {
//         idCardTypeOpts: this.idCardTypeOpts,
...
//         // 溶栓相对禁忌症选项
//         rsRelativeTabooList: this.rsRelativeTabooList,
//         // 溶栓拒绝原因选项
...
//         whereaboutsOpts: this.whereaboutsOpts,
...
//         phepConsciousnessOpts: this.phepConsciousnessOpts,
...
//         qrCodeOpts: this.qrCodeOpts,
//         reportStatusOpts: this.reportStatusOpts,
//         conditionGradeOpts: this.conditionGradeOpts,
//         rescueChangeResultOpts: this.rescueChangeResultOpts,
//         tntUnit: this.tntUnit
//       }
//     }
//   },
//   methods: {
...
//       }).then(({ result }) => {
//         this.idCardTypeOpts = result[dicConstant.idCardType]
...
//         this.phAnticoagulationOpts =
//                     result[dicConstant.phAnticoagulationCode]
...
//         this.whereaboutsOpts = result[dicConstant.whereabouts]
...
//         this.medicalHisProTypeOpts =
//                     result[dicConstant.medicalHisProTypeCode]
//         this.allergicHistoryOpts = result[dicConstant.allergicHistoryCode]
//         this.comeTypeOpts = result[dicConstant.comeType]
//         this.phepConsciousnessOpts =
//                     result[dicConstant.phepConsciousnessCode]
...
//         this.qrCodeOpts = result[dicConstant.qrCode]
//         this.reportStatusOpts = result[dicConstant.reportStatus]
//         this.conditionGradeOpts = result[dicConstant.conditionGrade]
//         this.rescueChangeResultOpts = result[dicConstant.rescueChangeResult]
//         this.tntUnit = result[dicConstant.tntUnit]
