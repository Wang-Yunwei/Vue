<template>
  <div class="med-lab-result-field-wrapper">
    <med-hint-field
      v-bind="$props"
      :readonly="readonly"
      :disabled="disabled"
    ...
    >
      ...
      <template #input-part>
        <van-row class="lab-result-field">
          <van-col :span="14">
            <van-field
              v-model="result"
              :readonly="readonly"
  ...
  methods: {
    ...
    update(val) {
      if (val) {
        ...
        this.result = val.value ? val.value : ''
      }
    }
  },
  computed: {
