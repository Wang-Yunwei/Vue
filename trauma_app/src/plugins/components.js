...
import MedRadioButtonRectangleGroup from '@/components/common/MedRadioButtonGroup/indexRectangle'
...
import MedDatePicker from '@/components/common/MedDatePicker/index.jsx'
...
import MedCheckboxButtonGroup from '@/components/common/MedCheckboxButtonGroup/index'
...
export default {
  install: Vue => {
    ...
    Vue.component('med-radio-button-rectangle-group', MedRadioButtonRectangleGroup)
    ...
    Vue.component('med-card-field', MedIdcardField)
    ...
    Vue.component('med-checkbox-button-group', MedCheckboxButtonGroup)
  }
}
